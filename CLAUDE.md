...
**DATE FORMAT RULE: Never write dates as BC, AD, BCE, or CE in narration. Instead convert to years ago or years from now. Example: "630 BC" → "about two thousand six hundred years ago", "1944 AD" → "about eighty years ago". Use round numbers and natural phrasing — this is spoken narration, not a textbook.**
