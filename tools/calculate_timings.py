...
SECTIONS = [
    ("hook",             [("s1_hook", 6)]),
    ("the_word",         [("s2_the_word", 13)]),
    ("ancient_wisdom",   [("s3_ancient_wisdom", 12)]),
    ("dismantling",      [("s4_dismantling_pt1", 14), ("s4_dismantling_pt2", 16)]),
    ("modern",           [("s5_modern_pt1", 12), ("s5_modern_pt2", 13)]),
    ("close",            [("s6_close", 12)]),
]
